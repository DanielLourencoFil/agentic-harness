...
(~/.claude/projects/), the plan-mode draft dir (~/.claude/plans/ — the file
    ...
    print(json.dumps({
        "hookSpecificOutput": {
            ...
            "permissionDecisionReason": (
                ...
                " rascunho do plan mode (~/.claude/plans/), scratchpad da sessão"
                " (/tmp/claude-*) e o repo de dados"
